...
// datas.sort((acc1,acc2)=>acc2.balance-acc1.balacnce).forEach(acc=>console.log(acc))

//debit transaction of account 1000

// datas.filter(account=>account.acno==1000).forEach(account=>console.log(account.transactions))

//accno 1000 credit transactions.

//payment history of 1001
console.log(datas.map(history=>transactions[1000]));